...
6 tabbed case studies. Each tab shows a summary by default; clicking "Read full case →" expands the full case study. Sensitive details (client names, financial specifics, personnel matters) are intentionally omitted.
...
**Implemented:** Where processes did not exist, I designed them. Where the CRM did not reflect how work needed to flow, I reconfigured it. This meant team members were onboarded into a working system rather than a broken one, and could take over and onboard others in turn. Approximately 12 employees and interns were hired, onboarded and integrated into structured workflows across sales, facility management, helpdesk and client operations. Where automations proved unreliable in practice, workflows were temporarily reverted to manual processes first — so the team understood the underlying logic before automation was reintroduced.
...
**My Role:** Led the troubleshooting process and coordinated the infrastructure change. Subsequently trained the on-site team to manage and operate the system independently.
...
**My Role:** Coordinated the pilot end to end — from setting up the camera infrastructure to overseeing development of a dashboard to make the data usable for operational teams.
...
**My Role:** Led the stakeholder development process — identifying, interviewing and recruiting private organisations, aligning them with the public partners involved, securing funding and organising the regional launch event.
