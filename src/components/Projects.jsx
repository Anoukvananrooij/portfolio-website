...
const SUPPORTING_PROJECTS = [
  {
    ...
    summary: 'Troubleshot a cloud-based access control system for a 700-user 24/7 building. Root cause: gateway networking issue, resolved by switching to wired connections.',
    topics: ['Access Control', 'Troubleshooting', 'Team Training'],
  },
  {
    title: 'AI Camera Analytics Pilot',
    summary: 'Coordinated an AI camera analytics pilot with a usage dashboard — people counting in an outdoor environment, generating operational insights.',
    topics: ['AI Cameras', 'Dashboard', 'Pilot Management'],
  },
  {
    title: 'Regional Smart Mobility Network',
    summary: 'Built a regional stakeholder network around a shared smart mobility roadmap — interviewed ~60 organizations, secured funding, organized kickoff event.',
