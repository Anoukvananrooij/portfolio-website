...
const PROJECTS = [
  {
    ...
    title: 'Operational Management of a Large Multi-Tenant Coworking Facility',
    summary: 'Carrying full operational responsibility for a large multi-tenant coworking facility — implementing a broad security programme, building and developing the operational team, and completing a CRM migration across locations, all in parallel.',
    context: 'A large multi-tenant coworking facility with 24/7 operations and a broad, diverse user base. As location manager, I carried full operational responsibility — across client satisfaction, team management, facility management, sales, events, HR and financial reporting — while running three significant workstreams in parallel.',
    role: 'I coordinated the security programme together with the CEO and external partners, designed the operational processes and workflows the team would work within, and drove the CRM migration across multiple locations. Where a function needed to be covered while the right person was still being onboarded, I stepped into that role directly and handed it over once the team member was up to speed.',
    implemented: 'On the security side, access control policies were tightened and the system was switched to wired connections to improve reliability. The access control database was restructured and cleaned. A new key management process was designed and rolled out. Mechanical security throughout the building was strengthened and closing rounds were redesigned. The existing camera infrastructure was extended with new monitoring software and an external partner was contracted for nightly surveillance. Member communication was kept structured and proactive throughout. Collaboration with local law enforcement was intensified in parallel.\n\nApproximately 12 employees and interns were hired, onboarded and integrated into structured workflows across sales, facility management, helpdesk and client operations. Processes were designed from scratch where needed. Where automations proved unreliable, workflows were run manually first — so team members understood the underlying logic before automation was introduced.\n\nThe CRM migration covered multiple locations. The new system was configured to reflect how work actually needed to flow, with operational pipelines built to guide team members step by step through sales, administrative actions, handovers and task management — giving teams a system they could operate and build on independently.',
    result: 'The security programme delivered measurable results, including close collaboration with law enforcement that contributed to identifying the individual responsible for the incidents. Member trust was maintained throughout. The operational team became capable of running the building independently within the structures we built together. The CRM migration was completed across locations, and client feedback reflected strong and stable service levels.',
    topics: ['Operations Management', 'Security Implementation', 'Team Building', 'CRM Migration'],
  },
  {
